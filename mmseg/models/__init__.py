...
from .builder import (BACKBONES, HEADS, LOSSES, SEGMENTORS, RESTORMER,build_restormer,build_backbone,
...
__all__ = [
    'BACKBONES', 'HEADS', 'LOSSES', 'SEGMENTORS', 'build_backbone','build_restormer', 'RESTORMER', #!!
